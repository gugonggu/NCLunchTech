  ...
  if (!employee) {
    return (
      <main className="flex flex-1 flex-col items-center justify-center gap-4 bg-brand-bg px-6 py-12 text-center">
        ...
        <p className="text-neutral-700">앤시정보기술 동료들과 점심 메뉴를 정하는 사내 서비스입니다.</p>
        <div className="flex w-full flex-col gap-2">
          <Link href="/login" className="rounded-2xl bg-brand px-4 py-3 text-center font-semibold text-white">
            로그인
          </Link>
          <Link
            href="/signup"
